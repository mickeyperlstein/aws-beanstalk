...
<head>
  ...
  .textColumn {
    ...
    background-image: -webkit-gradient(radial, 0 0, 1, 0 0, 500, from(BLACK), to(PURPLE));
  }
  .textColumn p {
    width: 75%;
    float:right;
...
<body id="sample">
  <div class="textColumn">
    <h1>Congratulations THIS IS A NEW VERSION</h1>
    <BR>
  ...
  <h3>Congratulations THIS IS A NEW VERSION</h3>
